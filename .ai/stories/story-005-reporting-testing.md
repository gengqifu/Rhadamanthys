...
## Tasks
1. 测试任务
   - [x] 设计测试：输入若干 Findings，验证 Excel 配色/排序/覆盖统计，JSON/CSV 输出正确
   - [x] 编写测试断言：字段完整、配色规则、风险降序+规则ID 升序、覆盖统计数值
2. 开发任务
   - [x] 实现报告生成器：Excel（条件格式、排序、覆盖统计）、JSON/CSV
   - [x] 证据格式与中文建议输出
3. 验证
   - [x] 运行测试，全部通过后标记完成
4. 示例与用例
   - [x] 示例项目与示例报告生成脚本/步骤，验证关键用例覆盖
